        ...
        <div className="mx-6 py-10 text-center md:text-left">
          <div className="grid-1 grid gap-10 md:grid-cols-2 lg:grid-cols-3">
            <div>
              ...
              <p>
                Welcome to MarkInsights, your go-to destination for personalized
                ad recommendation and all insights based on user data
              </p>
            </div>
            <div className="px-10">
              ...
              <p className="mb-4">
                <a href="/csvupload" className=" text-black">
                  csvupload
                </a>
              </p>
              <p className="mb-4">
