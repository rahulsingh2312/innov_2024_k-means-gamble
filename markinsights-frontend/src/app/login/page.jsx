...
<div className="LOGIN-FORM bg-[#ffffff]">
        <div className="flex">
...
{/* actual form */}
<div className='md:w-2/5 bg-[#ffffff]'>
...
<div className="flex md:w-96  justify-center ml-3 items-center h-screen bg-[#ffffff]">
      <div className="w-full  h-auto bg-[#000000] p-8  shadow-lg">
